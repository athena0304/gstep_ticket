...
gulp.task('scripts', function() {
  gulp.src(['src/js/count.js', 'src/js/home.js'])
    .pipe(concat('main.js'))
...
gulp.task('default', ['testLess','concatcss','scripts', 'testWatch']); //定义默认任务 elseTask为其他任务，该示例没有定义elseTask任务
